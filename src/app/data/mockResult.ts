...
export const mockResult = {
  company: "SK텔레콤",
  incidentType: "개인정보 유출 안내",
  riskLevel: "높음",
  riskScore: 82,

  leakedItems: ["이름", "전화번호", "이메일", "가입 정보"],

  risks: ["스미싱", "피싱", "통신사 사칭", "계정 탈취"],
  ...
  checklist: [
    "동일한 비밀번호를 사용하는 사이트의 비밀번호를 변경하세요.",
    "이메일, 통신사, 금융 계정에 2단계 인증을 설정하세요.",
    "문자에 포함된 링크는 누르지 말고 공식 홈페이지로 직접 접속하세요.",
    "보상금, 환불, 본인인증을 요구하는 문자는 피싱 가능성을 의심하세요.",
    "추가로 받은 의심 문자는 공식 고객센터를 통해 확인하세요.",
  ],
